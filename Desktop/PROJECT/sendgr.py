...
try:
    ...
    print(
        "Invalid credentials, try logging in again or in gmail settings of your account allow less secure apps option to be ON")
    sys.exit()
...
msg.attach(MIMEText(body, 'plain'))import csv
import smtplib
from email.mime.multipart import MIMEMultipart
from email.mime.text import MIMEText
import sys
